...
public class DbRepository<T> : IRepository<T, int> where T : DbEntity, new()
{
    private readonly DbContext _Db; // Контекст БД

    private static bool IsDeletedEntity => typeof(DeletedDbEntity).IsAssignableFrom(typeof(T));
